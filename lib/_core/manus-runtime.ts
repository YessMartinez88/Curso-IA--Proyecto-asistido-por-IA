/**
 * @archivo lib/_core/manus-runtime.ts
...
const DEBUG = true;
/**
 * Implementa la operación log dentro de este módulo.
 */
...
/**
 * Determina si se cumple la condición isInIframe.
 */
...
/**
 * Determina si se cumple la condición isWeb.
 */
...
/**
 * Implementa la operación sendToParent dentro de este módulo.
 */
...
/**
 * Determina si se cumple la condición isValidInsets.
 */
...
/**
 * Gestiona la interacción Message iniciada desde la interfaz.
 */
