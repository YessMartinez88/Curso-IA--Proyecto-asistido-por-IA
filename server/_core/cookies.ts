...
/**
 * Determina si se cumple la condición isIpAddress.
 */
...
/**
 * Determina si se cumple la condición isSecureRequest.
 */
...
/**
 * Obtiene la información necesaria para SessionCookieOptions dentro del flujo actual.
 */
